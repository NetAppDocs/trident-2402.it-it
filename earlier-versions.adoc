...
[role="lead"]
Se non utilizzi Astra Trident 24,02, la documentazione per le release precedenti è disponibile in base a. link:get-help.html["Ciclo di vita del supporto di Astra Trident"].
