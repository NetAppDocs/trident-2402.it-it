...
.Prima di iniziare
Accedi all'host Linux e verifica che stia gestendo un sistema operativo funzionante link:../trident-get-started/requirements.html["Cluster Kubernetes supportato"^] e che tu disponga dei privilegi necessari.
