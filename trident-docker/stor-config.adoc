...
Per informazioni su FlexGroups e sui carichi di lavoro adatti a FlexGroups vedi il  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Guida all'implementazione e alle Best practice per i volumi NetApp FlexGroup"^].
