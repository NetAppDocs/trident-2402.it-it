...
Utilizzando l'[`tridentctl`utility, puoi eseguire il `get`comando per ottenere i volumi subordinati. Per ulteriori informazioni, consulta link:../trident-managing-k8s/tridentctl.html[`tridentctl` comandi e opzioni].
...
* Guarda la demo su link:https://www.netapp.com/video/solutions-and-products/["NetAppTV"^].
