...
Se aggiungi un cluster ad Astra Control Service su cui Astra Trident non è stato precedentemente installato, il cluster verrà contrassegnato come  `Eligible`. Dopo che hai aggiunto il cluster ad Astra Control, Astra Control Provisioner verrà abilitato automaticamente.
...
. [[no-registry]]Abilita Astra Control Provisioner in Astra Trident utilizzando il metodo di installazione che hai utilizzato originariamente:
+
[role="tabbed-block"]
====
.Operatore Astra Trident
--
.. https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-operator.html#step-1-download-the-trident-installer-package["Scaricare il programma di installazione di Astra Trident ed estrarlo"^].
...
.tridentctl
--
.. https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-tridentctl.html#step-1-download-the-trident-installer-package["Scaricare il programma di installazione di Astra Trident ed estrarlo"^].
