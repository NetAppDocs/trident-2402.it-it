...
https://www.netapp.com/google-cloud/netapp-volumes/["NetApp Cloud Volumes Service per Google Cloud"^] è un file service cloud native che fornisce volumi NAS su NFS e SMB con performance all-flash. Questo servizio ti permette di eseguire qualsiasi workload, incluse le applicazioni legacy, nel cloud GCP. Fornisce un servizio gestito che offre performance elevate e costanti, clonazione istantanea, protezione dei dati e accesso sicuro alle istanze di Google Compute Engine (GCE).
