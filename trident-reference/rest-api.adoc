...
[role="lead"]
Anche se link:../trident-managing-k8s/tridentctl.html["comandi e opzioni tridentctl"] sono il modo più semplice per interagire con l'Astra Trident REST API, puoi usare direttamente l'endpoint REST se preferisci.
